      ...
      <div className="container-mid" ref={ref}>
        <motion.div
          ...
          style={{
            ...
            padding: '64px 32px',
            overflow: 'hidden',
            background: 'linear-gradient(145deg, rgba(29,78,216,0.18) 0%, var(--bg-card-to) 55%, rgba(5,150,105,0.10) 100%)',
        ...
        >
          ...
          />
          <div style={{ position: 'absolute', top: -40, left: -40, width: 160, height: 160, borderRadius: '50%', background: 'radial-gradient(circle, rgba(29,78,216,0.16) 0%, transparent 70%)', filter: 'blur(30px)', pointerEvents: 'none' }} />
          <div style={{ position: 'absolute', bottom: -40, right: -40, width: 200, height: 200, borderRadius: '50%', background: 'radial-gradient(circle, rgba(5,150,105,0.14) 0%, transparent 70%)', filter: 'blur(40px)', pointerEvents: 'none' }} />
          <div style={{ position: 'absolute', top: 0, left: '10%', right: '10%', height: 1, background: 'linear-gradient(90deg, transparent, rgba(29,78,216,0.50), transparent)', pointerEvents: 'none' }} />
          ...
          <div style={{ position: 'relative', zIndex: 10 }}>
            ...
            <motion.p
              ...
              style={{ fontSize: '1rem', color: 'var(--text-muted)', maxWidth: 520, margin: '0 auto 36px', lineHeight: 1.75 }}
            >
