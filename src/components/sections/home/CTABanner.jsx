      ...
      <div className="container-mid" ref={ref}>
        <motion.div
          ...
          style={{
            ...
            padding: '64px 32px',
            overflow: 'hidden',
            background: 'linear-gradient(145deg, rgba(30,77,140,0.55) 0%, rgba(11,17,32,0.9) 60%, rgba(30,77,140,0.35) 100%)',
        ...
        >
          ...
          <motion.div
            ...
            style={{
              ...
              background: 'radial-gradient(ellipse 70% 60% at 50% 50%, rgba(59,130,246,0.14) 0%, transparent 65%)',
            }}
          />
          {/* Corner glows */}
          <div style={{
          ...
          <div style={{ position: 'relative', zIndex: 10 }}>
            ...
            <motion.p
              ...
              style={{ fontSize: '1rem', color: 'rgba(96,180,255,0.68)', maxWidth: 520, margin: '0 auto 36px', lineHeight: 1.72 }}
            >
            ...
            >
              <motion.div whileHover={{ scale: 1.04, y: -2 }} whileTap={{ scale: 0.97 }}>
                <Link
                  ...
                  style={{
                    ...
                    padding: '14px 32px', borderRadius: 14, fontSize: '1rem', fontWeight: 700,
                    color: 'white', textDecoration: 'none',
                    background: 'linear-gradient(135deg, #3B82F6, #1E4D8C)',
                    boxShadow: '0 8px 32px rgba(59,130,246,0.45), inset 0 1px 0 rgba(255,255,255,0.1)',
                  }}
                >
              ...
              <motion.div whileHover={{ scale: 1.04, y: -2 }} whileTap={{ scale: 0.97 }}>
                <Link
                  ...
                  style={{
                    display: 'inline-flex', alignItems: 'center', gap: 8,
                    padding: '14px 32px', borderRadius: 14, fontSize: '1rem', fontWeight: 600,
